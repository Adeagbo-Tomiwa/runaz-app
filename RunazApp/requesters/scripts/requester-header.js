window.RunazRequesterHeader = (function () {
    function view(cfg) {
      return `
  <header class="border-b dark:border-gray-800 bg-white/90 dark:bg-gray-900/80 backdrop-blur sticky top-0 z-40">
    <div class="max-w-7xl mx-auto h-16 px-4 sm:px-6 lg:px-8 flex items-center justify-between">
      ...
      <div class="flex items-center gap-2">
        ...
        <a href="/requesters/index.html" class="flex items-center gap-2 min-w-0">
          ...
          <span class="hidden sm:inline text-xs font-semibold px-2 py-0.5 rounded-full bg-gray-100 dark:bg-gray-800 ml-2">Requester</span>
        </a>
      </div>
    ...
    function init(userCfg = {}) {
      ...
      if (!el) return console.warn('RunazRequesterHeader: mount not found');
